...
class _AddMemberScreenState extends State<AddMemberScreen> {
  ...
  @override
  void initState() {
    familyRoleIdController.text = AppConstant.dataFamilyRole[0];
    familyBloc = sl();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBarHome.appBarWithLeading(context, title: 'Add Family'),
                  ...
                  DropdownButtonFormField<String?>(
                    ...
                    onChanged: (value) {
                      setState(() {
                        ...
                        familyRoleName = listFamilyRoleResponse
                            .where(
                                (element) => element.id.contains(value ?? ""))
                            .first
                            .name;
                      });
                    },
                      ...
                      onPressed: (familyState is FamilyStateLoading)
                          ...
                          : () {
                              if (_formKey.currentState!.validate()) {
                                ...
                                familyBloc.add(FamilyEventAddMember(
